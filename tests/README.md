...
unit, build and types projects. Only the 7 files in `browser-harness/migration.json` use `jest-legacy.setup.ts`.
...
`@addon-core/*` and `@main/env`. Eight additional files still use these local mocks, making 15 files to review in total.
