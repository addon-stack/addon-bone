...
type RelayMethodsMap = Map<string, RelayMethod | undefined>;
...
const getRelayMethodsMap = (): RelayMethodsMap => {
    ...
    try {
        ...
        Object.entries<RelayMethod | undefined>(__ADNBN_RELAY_METHODS__)
...
export const getRelay = <N extends Extract<keyof TransportDictionary, string>>(
    ...
    const method = getRelayMethodsMap().get(name) || RelayMethod.Messaging;
